<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexOmnivox.aspx.cs" Inherits="Practice3.indexOmnivox" %>
    ...
    <div class="login">
        <form id="form1" runat="server" class="form">
            ...
            <div class="auto-style4">
                ...
                <div  >
                    <asp:Button ID="btnEntrer" CssClass="btnLogin" runat="server" Text="Entrer" Font-Bold="True" OnClick="btnEntrer_Click" />
                 </div>
                 <div class="btnLink">
